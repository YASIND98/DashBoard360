...
public class GetProductivityCountCardPosRatioRegionReportTableHeadersItem
{
    public string RowNumberTitle { get; set; } = string.Empty;
    public string RatioNameTitle { get; set; } = string.Empty;
    public string PreviousQuarterRegionTitle { get; set; } = string.Empty;
    public string CurrentRegionTitle { get; set; } = string.Empty;
