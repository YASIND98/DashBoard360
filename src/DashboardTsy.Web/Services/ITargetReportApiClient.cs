...
public interface ITargetReportApiClient
{
    ...
    Task<GetDailyQuantityTargetReportTableHeadersResponse?> GetDailyQuantityTargetReportTableHeadersAsync(GetDailyQuantityTargetReportTableHeadersRequest request, CancellationToken cancellationToken = default);
